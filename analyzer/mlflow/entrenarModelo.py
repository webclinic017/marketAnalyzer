...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  3 21:01:33 2022
...
def realizarAnalisis(serie_train,serie_test,serie,stock,nas,minimo,transformar,DIVISOR,exchange):
...
def analizarFundamental(exchange,stock):
    ...
    try:
        ...
        if len(data)>tamMinimo:
            ...
            print(data1.tail())
            #print(serie_test)
            modelos=realizarAnalisis(serie_train,serie_test,serie,stock,nas,minimo,transformar,DIVISOR,exchange)
