...
if __name__ == '__main__':
    ...
    variables_macro_externas = config["prophet"]["variables_macro_fijas"][pais]
    # si se quiere predecir una variable macro
    if feature_macro not in variables_macro_externas and config["prophet"]["predict_macro"]:
    ...
    if config["prophet"]["predict_macro"]:
