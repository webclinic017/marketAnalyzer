...
def hurst_diffusion(time_series, max_lag=200):
...
def hurst_exponent(prices, min_chunksize=8, max_chunksize=200, num_chunksize=5,
    ...
    if method == 'RS':
        ...
        return {
            'RS':hurst_exponent(arr, min_chunksize, max_chunksize, num_chunksize, 'RS'),
            'DMA':hurst_exponent(arr, min_chunksize, max_chunksize, num_chunksize, 'DMA'),
            'DSOD':hurst_exponent(arr, min_chunksize, max_chunksize, num_chunksize, 'DSOD'),
            'difussion':hurst_diffusion(arr,max_chunksize)
        }
    else:
